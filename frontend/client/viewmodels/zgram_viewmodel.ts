...
export class ZgramViewModel {
    ...
    private makeQueryOnSender() {
        ...
        return new InitialQuery(queryText, searchOrigin, this.state.filtersViewModel.allFilters9);
    }
    ...
    private makeQueryOnTimestamp() {
        ...
        return new InitialQuery("", searchOrigin, this.state.filtersViewModel.allFilters9);
    }

    private makeQueryOnZgramId() {
        return new InitialQuery(`zgramid(${this.zgramId.raw})`, SearchOrigin.ofEnd(),
            this.state.filtersViewModel.allFilters9);
    }
